...
Detailed documentation on how to create mods can be found here:

[PPR Utilities - Docs](https://github.com/CruS-Modding-Infrastructure/ppr-modloader/blob/main/docs/EN/main.md)
